...
SECRET_KEY = 'django-insecure-p8cfha9-57*tt*ph51g=5g0d3ocn(sx1@k09f!8-*+8-oj=1(d'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myserver.context_processors.menu_list',
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = "vutmqqekngntopbo" # "PKNUbrother1302!"
